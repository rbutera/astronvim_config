...
return {
  ...
  -- },
  {
    ...
    keys = {
      ...
      { "<Leader>A", "<Cmd>MultipleCursorsJumpNextMatch<CR>", mode = { "n", "x" }, desc = "Skip to next cword" },
      -- { "<Leader>A", "<Cmd>MultipleCursorsAddJumpNextMatchV<CR>", mode = { "n", "x" }, desc = "Jump to next cword" },
